...
import com.okuklina.pallas.data.DictionariesContract.Items;
...
public class ItemsProvider extends ContentProvider {
	...
	private static UriMatcher buildUriMatcher() {
		...
		String authority = DictionariesContract.CONTENT_AUTHORITY;
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch (match) {
			case ItemsProvider.ITEMS:
				...
				return DictionariesContract.Items.buildItemUri(_id);
			default:
				throw new UnsupportedOperationException("Unknown uri: " + uri);
		}
	}
	...
	private SelectionBuilder buildSelection(Uri uri, int match, SelectionBuilder builder) {
		...
		switch (match) {
			...
			case ItemsProvider.ITEMS__ID:
				...
				return builder.table(Tables.ITEMS).where(DictionariesContract.Items._ID + "=?", _id);
			default:
				throw new UnsupportedOperationException("Unknown uri: " + uri);
		}
	}
